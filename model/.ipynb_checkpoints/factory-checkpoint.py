...
written by wgchang
"""
from model import lenet, alexnet, resnetdsbn, resnetdsbw
__sets = {}

for model_name in ['lenet', 'lenetdsbn', 'alexnet', 'resnet50', 'resnet101', 'resnet152', 'resnet50dsbn',
                   'resnet101dsbn',  'resnet152dsbn', 'resnet50dsbw', 'resnet101dsbw']:
    ...
    elif model_name in ['resnet50dsbw', 'resnet101dsbw', 'resnet152dsbw']:
        eval_str = "resnetdsbw.{}"
        # __sets[model_name] = (lambda num_classes, in_features, pretrained, num_domains,
        #                              model_name=model_name, eval_str=eval_str:
        #                       eval(eval_str.format(model_name))(pretrained=pretrained, num_classes=num_classes,
        #                                                         in_features=in_features, num_domains=num_domains, **kwargs))
        __sets[model_name] = (lambda num_classes, in_features, pretrained, num_domains,
                                     model_name=model_name, eval_str=eval_str, **kwargs:
                              eval(eval_str.format(model_name))(pretrained=pretrained, num_classes=num_classes,
                                                                in_features=in_features, num_domains=num_domains, **kwargs))
