...
# for Office DA
OFFICE_DIR = './data/domain_adaptation_images'
JITTERS = ['None', ]
for model_name in ['alexnet', 'resnet50', 'cresnet50', 'resnet50dsbn', 'cpuanet50', 'cpuanet50dsbn', 'resnet50dsbw']:
    for split in SPLITS:
        for jitter in JITTERS:
...
OFFICEHOME_DIR = './data/OfficeHomeDataset_10072016/OfficeHomeDataset_10072016'
JITTERS = ['None', ]
